        ...
        <div className="row home-top">
          ...
          <div className="col-lg-12 fondo">
            <Link to="/registrousuarios">
              ...
              <a className="texto-link"><span className="icono-der"><FontAwesomeIcon icon={faPerson} />  </span>Agregar Nuevo Usuario</a>
            </Link>
          ...
          <div className="col-lg-12 fondo3">
            <Link to="/busquedausuario">
              ...
              <a className="texto-link"><span className="icono-der"><FontAwesomeIcon icon={faMagnifyingGlass} />  </span> Buscar Usuario </a>
            </Link>
